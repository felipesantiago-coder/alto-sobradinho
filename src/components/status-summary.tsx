...
const statusConfig = {
  ...
  reservadas: {
    label: 'Reservadas',
    color: 'bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-900/40 dark:text-yellow-300 dark:border-yellow-700',
  ...
  foraDeVenda: {
    label: 'Fora de Venda',
    color: 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-800/40 dark:text-gray-300 dark:border-gray-700',
...
export function StatusSummary({
  ...
  return (
    <Card className="mb-6 border-0 shadow-md bg-white/80 backdrop-blur dark:bg-slate-800/80">
